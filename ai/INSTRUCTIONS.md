...
This scraper extracts job listings for **KRONOSPAN SEBES SA** (CIF: 11358544) from
the company's own careers site, validates the company via ANAF, and imports
the jobs to peviitor.ro.

Targets: https://kronospan-candidate.talent-soft.com/pages/offre/listeoffre.aspx?lcid=1048&facet_Entity=473, 
...
- **Kronospan — listing**: `https://kronospan-candidate.talent-soft.com/pages/offre/listeoffre.aspx?lcid=1048&facet_Entity=473` — pagina publică de posturi deschise
- **Kronospan — sitemap**: `` — permalink-uri canonice
