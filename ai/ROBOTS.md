...
Fill this in per derived company. Check `https://kronospan.com/robots.txt` before the
...
| Path | Role |
|---|---|
| `https://kronospan-candidate.talent-soft.com/pages/offre/listeoffre.aspx?lcid=1048&facet_Entity=473` | Public list of open positions (server-rendered HTML) |
| `` | Job sitemap — canonical `https://kronospan-candidate.talent-soft.com/job/<slug>/` permalinks |
| `https://kronospan-candidate.talent-soft.com/job/<slug>/` | Individual job pages (only referenced, not fully crawled) |
