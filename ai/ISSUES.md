...
Acest proiect folosește [GitHub Issues](https://github.com/TheTatu13/kronospan-sebes-python-scraper/issues) pentru a urmări munca.
...
Vezi [toate issue-urile](https://github.com/TheTatu13/kronospan-sebes-python-scraper/issues).
